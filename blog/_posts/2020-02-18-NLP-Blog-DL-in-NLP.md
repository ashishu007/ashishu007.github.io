...
As discussed in above section, the word embeddings generated by algorithms like word2vec and GloVe lack the contextual awareness and fail to differentiate a word with different sense. A new version of words embeddings, kown as, contextual word embeddings are capable of differentiating a word's sense based on its context. These new models use an Language Model (LM) to generate the contextualised representation of words in a sentence. These modified embeddings generated from the LMs can be used as the input to another neural network for some downstream tasks.
...
<div style="text-align: center;"><b>A Transformer</b></div>
...
### Google's Bidirectional Encoder Representation from Transformers
...
<div style="text-align: center;"><b>BERT Model</b></div>
...
**Note**: For a better and deeper understanding please refer to these amazing blogs by Jay Alammar ([Transformers](http://jalammar.github.io/illustrated-transformer/), [BERT](http://jalammar.github.io/illustrated-bert/)).
