...
These obituaries were extracted from [Funeral-Notices](https://funeral-notices.co.uk/), <div style="text-align: justify"> one of the most famous obituary publishing websites in the UK. After reading multiple obituaries, I identified around 40 features to represent an obituary and then annotated around 100 obituaries with those features. The list of identified features is shown in the figure below.</div>
